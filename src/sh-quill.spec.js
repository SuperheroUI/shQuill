...
var ShQuill = require('./sh-quill').default;

describe('root', function () {
    it('renders without problems', function () {
        let value = 'Test';
        var root = TestUtils.renderIntoDocument(<ShQuill value={value}/>);
    ...
    it('set classes from parent', function () {
        let value = '';
        var root = TestUtils.renderIntoDocument(<ShQuill className="spam" value={value} />);
        let rootNode = ReactDOM.findDOMNode(root);
    ...
    it('handle having outside onBlur', function () {
        ...
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} onBlur={onBlur}  onChange={changeMe} />);
    ...
    it('handle having outside onFocus', function () {
        ...
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} onFocus={onFocus} onChange={changeMe} />);
        expect(root.state).toBeTruthy();
        let input = TestUtils.findRenderedDOMComponentWithClass(root, 'quill-contents');
    ...
    it('handle having outside onChangeSelection', function () {
        ...
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} onChangeSelection={selectMe} onChange={changeMe} />);
    ...
    it('should be able to unmount a plane component', function() {
        let value = '';
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} required />);
        ReactDOM.unmountComponentAtNode(ReactDOM.findDOMNode(root).parentNode);
    });
    ...
    it('should set the default font and size', function() {
        ...
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} onChange={changeMe} defaultFont={defaultFont} defaultFontSize={defaultFontSize} />);
        let input = TestUtils.findRenderedDOMComponentWithClass(root, 'quill-contents');
        TestUtils.Simulate.blur(input);
        root.clearText();
    ...
    it('should validate when updating the text', function () {
        ...
        var root = TestUtils.renderIntoDocument(<ShQuill value={value} validator={validator} onChange={changeMe} />);
        root.handleChange({
            target: {
