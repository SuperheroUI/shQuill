...
class App extends React.Component {
    ...
    render() {
        return (
            <div>
                <ShQuill id="sh-react-quill-editor" ref="editor" value={this.state.text} required={true} onChange={this.handleChange} onBlur={this.handleBlur}
                ...
                <button className="sh-btn" onClick={this.handleSubmit}>Submit</button><br />
